...
* [#1177](https://github.com/java-native-access/jna/pull/1177): Add `Memory#getString` and `Memory#getWideString` overloads with a maxBytes parameter - [@dbwiddis](https://github.com/dbwiddis).
